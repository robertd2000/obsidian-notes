Merge sort is a recursive sorting algorithm and, luckily for us, it’s quite a bit faster than [bubble sort](https://www.boot.dev/blog/golang/bubble-sort-golang/). Merge sort is a [divide and conquer algorithm](https://en.wikipedia.org/wiki/Divide-and-conquer_algorithm).

### [Divide](https://www.boot.dev/blog/golang/merge-sort-golang/#divide)

- Divide the input slice into two (equal) halves
- Recursively sort the two halves

### [Conquer](https://www.boot.dev/blog/golang/merge-sort-golang/#conquer)

- Merge the two halves to form a sorted array

![merge sort gif](https://www.boot.dev/blog/img/800/merge_sort_gif.gif)

## [Full example of the merge sort algorithm](https://www.boot.dev/blog/golang/merge-sort-golang/#full-example-of-the-merge-sort-algorithm)
...
![Copy to clipboard button](https://www.boot.dev/blog/icons/clipboard.svg)
...
## [Using the algorithm in code](https://www.boot.dev/blog/golang/merge-sort-golang/#using-the-algorithm-in-code)
...
## [Why use merge sort?](https://www.boot.dev/blog/golang/merge-sort-golang/#why-use-merge-sort)

### [Pros](https://www.boot.dev/blog/golang/merge-sort-golang/#pros)
...
### [Cons](https://www.boot.dev/blog/golang/merge-sort-golang/#cons)
...
If you need a sorting algorithm to use in a production system, I recommend [not reinventing the wheel and using the built-in sort.Sort method](https://www.boot.dev/blog/golang/sorting-in-go-dont-reinvent-this-wheel/).

## [Merge sort Big-O complexity](https://www.boot.dev/blog/golang/merge-sort-golang/#merge-sort-big-o-complexity)
