...
## [Conquer](https://www.boot.dev/blog/golang/quick-sort-golang/#conquer)

- Return a sorted array after all elements have been through the pivot operation

## [Quicksort Pseudocode](https://www.boot.dev/blog/golang/quick-sort-golang/#quicksort-pseudocode)

### [`partition()` function in Golang](https://www.boot.dev/blog/golang/quick-sort-golang/#partition-function-in-golang)
...
### [`quickSort()` function in Golang](https://www.boot.dev/blog/golang/quick-sort-golang/#quicksort-function-in-golang)
...
![](https://www.boot.dev/blog/img/800/quicksort_animation.gif)
...
## [Example of using Quicksort in real code](https://www.boot.dev/blog/golang/quick-sort-golang/#example-of-using-quicksort-in-real-code)
...
## [Why use Quicksort?](https://www.boot.dev/blog/golang/quick-sort-golang/#why-use-quicksort)
...
## [Ensuring a fast runtime in Quicksort](https://www.boot.dev/blog/golang/quick-sort-golang/#ensuring-a-fast-runtime-in-quicksort)
...
### [Random shuffling optimization](https://www.boot.dev/blog/golang/quick-sort-golang/#random-shuffling-optimization)
...
### [Finding the median optimization](https://www.boot.dev/blog/golang/quick-sort-golang/#finding-the-median-optimization)
