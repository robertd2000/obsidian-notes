...
## About[](https://google.github.io/styleguide/go/decisions#about)
...
## Naming[](https://google.github.io/styleguide/go/decisions#naming)
...
### Underscores[](https://google.github.io/styleguide/go/decisions#underscores)
...
Avoid uninformative package names like `util`, `utility`, `common`, `helper`, `model`, `testhelper`, and so on that would tempt users of the package to [rename it when importing](https://google.github.io/styleguide/go/decisions#import-renaming). See:
...
### Receiver names[](https://google.github.io/styleguide/go/decisions#receiver-names)
...
### Constant names[](https://google.github.io/styleguide/go/decisions#constant-names)
...
### Getters[](https://google.github.io/styleguide/go/decisions#getters)
...
### Variable names[](https://google.github.io/styleguide/go/decisions#variable-names)
...
- Omit [types and type-like words](https://google.github.io/styleguide/go/decisions#repetitive-with-type) from most variable names.
...
#### Single-letter variable names[](https://google.github.io/styleguide/go/decisions#single-letter-variable-names)
...
### Repetition[](https://google.github.io/styleguide/go/decisions#repetition)
...
#### Package vs. exported symbol name[](https://google.github.io/styleguide/go/decisions#package-vs-exported-symbol-name)
...
#### Variable name vs. type[](https://google.github.io/styleguide/go/decisions#variable-name-vs-type)
...
#### External context vs. local names[](https://google.github.io/styleguide/go/decisions#external-context-vs-local-names)
...
### Comment line length[](https://google.github.io/styleguide/go/decisions#comment-line-length)
...
### Doc comments[](https://google.github.io/styleguide/go/decisions#doc-comments)
...
### Comment sentences[](https://google.github.io/styleguide/go/decisions#comment-sentences)
...
### Examples[](https://google.github.io/styleguide/go/decisions#examples)
...
### Named result parameters[](https://google.github.io/styleguide/go/decisions#named-result-parameters)
...
### Package comments[](https://google.github.io/styleguide/go/decisions#package-comments)
...
## Imports[](https://google.github.io/styleguide/go/decisions#imports)

### Import renaming[](https://google.github.io/styleguide/go/decisions#import-renaming)
...
Local names for imported packages must follow [the guidance around package naming](https://google.github.io/styleguide/go/decisions#package-names), including the prohibition on the use of underscores and capital letters. Try to be [consistent](https://google.github.io/styleguide/go/guide#consistency) by always using the same local name for the same imported package.

An imported package _must_ be renamed to avoid a name collision with other imports. (A corollary of this is that [good package names](https://google.github.io/styleguide/go/decisions#package-names) should not require renaming.) In the event of a name collision, prefer to rename the most local or project-specific import.

Generated protocol buffer packages _must_ be renamed to remove underscores from their names, and their local names must have a `pb` suffix. See [proto and stub best practices](https://google.github.io/styleguide/go/best-practices#import-protos) for more information.
...
### Import grouping[](https://google.github.io/styleguide/go/decisions#import-grouping)
...
### Import “blank” (`import _`)[](https://google.github.io/styleguide/go/decisions#import-blank-import-_)
...
### Import “dot” (`import .`)[](https://google.github.io/styleguide/go/decisions#import-dot-import-)
...
### Returning errors[](https://google.github.io/styleguide/go/decisions#returning-errors)
...
### Error strings[](https://google.github.io/styleguide/go/decisions#error-strings)
...
### Handle errors[](https://google.github.io/styleguide/go/decisions#handle-errors)
...
### In-band errors[](https://google.github.io/styleguide/go/decisions#in-band-errors)
...
### Indent error flow[](https://google.github.io/styleguide/go/decisions#indent-error-flow)
...
## Language[](https://google.github.io/styleguide/go/decisions#language)
...
#### Field names[](https://google.github.io/styleguide/go/decisions#field-names)
...
#### Matching braces[](https://google.github.io/styleguide/go/decisions#matching-braces)
...
#### Cuddled braces[](https://google.github.io/styleguide/go/decisions#cuddled-braces)
...
#### Repeated type names[](https://google.github.io/styleguide/go/decisions#repeated-type-names)
...
#### Zero-value fields[](https://google.github.io/styleguide/go/decisions#zero-value-fields)
...
### Nil slices[](https://google.github.io/styleguide/go/decisions#nil-slices)
...
### Indentation confusion[](https://google.github.io/styleguide/go/decisions#indentation-confusion)
...
### Function formatting[](https://google.github.io/styleguide/go/decisions#function-formatting)
...
Avoid adding inline comments to specific function arguments where possible. Instead, use an [option struct](https://google.github.io/styleguide/go/best-practices#option-structure) or add more detail to the function documentation.
...
### Conditionals and loops[](https://google.github.io/styleguide/go/decisions#conditionals-and-loops)
...
### Copying[](https://google.github.io/styleguide/go/decisions#copying)
...
### Don’t panic[](https://google.github.io/styleguide/go/decisions#dont-panic)
...
### Must functions[](https://google.github.io/styleguide/go/decisions#must-functions)
...
### Goroutine lifetimes[](https://google.github.io/styleguide/go/decisions#goroutine-lifetimes)
...
### Interfaces[](https://google.github.io/styleguide/go/decisions#interfaces)

Go interfaces generally belong in the package that _consumes_ values of the interface type, not a package that _implements_ the interface type. The implementing package should return concrete (usually pointer or struct) types. That way, new methods can be added to implementations without requiring extensive refactoring. See [GoTip #49: Accept Interfaces, Return Concrete Types](https://google.github.io/styleguide/go/index.html#gotip) for more details.
...
### Generics[](https://google.github.io/styleguide/go/decisions#generics)
...
### `switch` and `break`[](https://google.github.io/styleguide/go/decisions#switch-and-break)
...
### Synchronous functions[](https://google.github.io/styleguide/go/decisions#synchronous-functions)
...
### Use any[](https://google.github.io/styleguide/go/decisions#use-any)
...
## Common libraries[](https://google.github.io/styleguide/go/decisions#common-libraries)

### Flags[](https://google.github.io/styleguide/go/decisions#flags)
...
### Logging[](https://google.github.io/styleguide/go/decisions#logging)
...
- Best practices on [logging errors](https://google.github.io/styleguide/go/best-practices#error-logging) and [custom verbosity levels](https://google.github.io/styleguide/go/best-practices#vlog)
...
### Contexts[](https://google.github.io/styleguide/go/decisions#contexts)
...
- In entrypoint functions (see below for examples of such functions), use [`context.Background()`](https://pkg.go.dev/context/#Background) or, for tests, [`tb.Context()`](https://pkg.go.dev/testing#TB.Context).
...
#### Custom contexts[](https://google.github.io/styleguide/go/decisions#custom-contexts)
...
### crypto/rand[](https://google.github.io/styleguide/go/decisions#cryptorand)
...
### Identify the function[](https://google.github.io/styleguide/go/decisions#identify-the-function)
...
### Identify the input[](https://google.github.io/styleguide/go/decisions#identify-the-input)
...
### Got before want[](https://google.github.io/styleguide/go/decisions#got-before-want)
...
### Full structure comparisons[](https://google.github.io/styleguide/go/decisions#full-structure-comparisons)
...
### Compare stable results[](https://google.github.io/styleguide/go/decisions#compare-stable-results)
...
### Keep going[](https://google.github.io/styleguide/go/decisions#keep-going)
...
### Equality comparison and diffs[](https://google.github.io/styleguide/go/decisions#equality-comparison-and-diffs)
...
### Level of detail[](https://google.github.io/styleguide/go/decisions#level-of-detail)
...
### Test error semantics[](https://google.github.io/styleguide/go/decisions#test-error-semantics)
...
## Test structure[](https://google.github.io/styleguide/go/decisions#test-structure)

### Subtests[](https://google.github.io/styleguide/go/decisions#subtests)
...
#### Subtest names[](https://google.github.io/styleguide/go/decisions#subtest-names)
...
### Table-driven tests[](https://google.github.io/styleguide/go/decisions#table-driven-tests)
...
Here is the minimal structure of a table-driven test. If needed, you may use different names or add extra facilities such as subtests or setup and cleanup functions. Always keep [useful test failures](https://google.github.io/styleguide/go/decisions#useful-test-failures) in mind.
...
More complicated logic in your test code, like complex error checking based on conditional differences in test setup (often based on table test input parameters), can be [difficult to understand](https://google.github.io/styleguide/go/guide#maintainability) when each entry in a table has specialized logic based on the inputs. If test cases have different logic but identical setup, a sequence of [subtests](https://google.github.io/styleguide/go/decisions#subtests) within a single test function might be more readable. A test helper may also be useful for simplifying test setup in order to maintain the readability of a test body.
...
#### Data-driven test cases[](https://google.github.io/styleguide/go/decisions#data-driven-test-cases)
...
#### Identifying the row[](https://google.github.io/styleguide/go/decisions#identifying-the-row)
...
### Test helpers[](https://google.github.io/styleguide/go/decisions#test-helpers)
...
### Test package[](https://google.github.io/styleguide/go/decisions#test-package)

#### Tests in the same package[](https://google.github.io/styleguide/go/decisions#tests-in-the-same-package)
...
#### Tests in a different package[](https://google.github.io/styleguide/go/decisions#tests-in-a-different-package)
...
### Use package `testing`[](https://google.github.io/styleguide/go/decisions#use-package-testing)
...
## Non-decisions[](https://google.github.io/styleguide/go/decisions#non-decisions)
